...
const external_services_calls = [
  {
    ...
    params: [
      ...
      {
        type: 'cObs', // TODO: VERIFICAR SE cObs É PRECISO ENVIAR COMO FILTRO
  ...
  },
  {
    ...
    params: [
      ...
      } // TODO: Ver como adicionar parametro de concorrentes pois é array
    ]
  },
  {
    name: 'ListarClientes',
    ...
    params: [
      ...
      {
        type: 'clientesFiltro', // TODO: POSSUI FILTRO Q RECEBE ARRAY
        verboseName: 'Filtrar os registros a partir de uma data.',
        filters: [
          {
          ...
          } // TODO: POSSUI FILTRO tags Q É UM ARRAY
        ]
      },
      {
        type: 'clientesPorCodigo', // TODO: ARRAY
  ...
  {
    name: 'PesquisarLancamentosRequest',
    value: 'PesquisarLancamentosRequest',
...
exports.handler = (evt, ctx, cb) =>
  cb(null, getOpts({ body: JSON.stringify(external_services_calls) }));
